...
| Claude skill wrapper | Canonical skill |
| --- | --- |
| `.claude/skills/question-routing/SKILL.md` | `agent-system/canonical/skills/question-routing/SKILL.md` |
| `.claude/skills/kb-answering/SKILL.md` | `agent-system/canonical/skills/kb-answering/SKILL.md` |
| `.claude/skills/repo-investigation/SKILL.md` | `agent-system/canonical/skills/repo-investigation/SKILL.md` |
