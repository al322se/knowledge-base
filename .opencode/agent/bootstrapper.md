...
# TODO: Add OpenCode version-specific permission fields allowing MCP discovery/read-only tools only. Do not invent MCP tool names.
---
...
Respect the canonical MCP policy: MCP discovery/read-only is allowed; write/action calls require explicit human confirmation.
